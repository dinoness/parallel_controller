	...
	GLOBAL SUB AXIS_CONGIF()
	    ...
	    GLOBAL CONST JOINT_L1_SPEED = 1
	    GLOBAL CONST JOINT_L2_SPEED = 5
	    GLOBAL CONST JOINT_L3_SPEED = 10
	    GLOBAL CONST JOINT_L1_ACC = 2
	    GLOBAL CONST JOINT_L2_ACC = 10
	    GLOBAL CONST JOINT_L3_ACC = 15
	END SUB